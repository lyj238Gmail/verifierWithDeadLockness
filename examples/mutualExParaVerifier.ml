...
let () = run_with_cmdline (fun () ->
  ...
  (*let cinvs_with_varnames, relations = find ~murphi:(In_channel.read_all "mutualEx-sca.m") ~symMethod:(true)  protocol in*) (*~symMethod:(true)*)
  
  (*let cinvs_with_varnames, relations = find ~murphi:(In_channel.read_all "n_mutualEx.m") ~symMethod:(true)  protocol in (*~symMethod:(true)*)*)
