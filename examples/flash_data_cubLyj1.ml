...
let _INV_MSG = List.concat [
  [arrdef [("Inv_Cmd", [])] "INV_CMD"]
]

let _RP_MSG = List.concat [
  [arrdef [("Rp_Cmd", [])] "RP_CMD"]
]

let _WB_MSG = List.concat [
  [arrdef [("Wb_Cmd", [])] "WB_CMD"];
  [arrdef [("Proc", [])] "NODE"];
  [arrdef [("HomeProc", [])] "boolean"];
  [arrdef [("Data", [])] "DATA"]
]
...
let n_PI_Remote_Get =
  ...
  let statement = (parallel [(assign (record [global "Sta"; arr [("Proc", [paramref "src"])]; global "ProcCmd"]) (const _NODE_Get)); (assign (record [global "Sta"; arr [("UniMsg", [paramref "src"])]; global "Uni_Cmd"]) (const _UNI_Get)); (assign (record [global "Sta"; arr [("UniMsg", [paramref "src"])]; global "HomeProc"]) (const (boolc true)))]) in
  rule name params formula statement
...
let n_PI_Remote_GetX =
  ...
  let params = [paramdef "src" "NODE"] in
  let formula = (andList [(eqn (var (record [global "Sta"; arr [("Proc", [paramref "src"])]; global "ProcCmd"])) (const _NODE_None)); (eqn (var (record [global "Sta"; arr [("Proc", [paramref "src"])]; global "CacheState"])) (const _CACHE_I))]) in
  let statement = (parallel [(assign (record [global "Sta"; arr [("Proc", [paramref "src"])]; global "ProcCmd"]) (const _NODE_GetX)); (assign (record [global "Sta"; arr [("UniMsg", [paramref "src"])]; global "Uni_Cmd"]) (const _UNI_GetX)); (assign (record [global "Sta"; arr [("UniMsg", [paramref "src"])]; global "HomeProc"]) (const (boolc true)))]) in
  rule name params formula statement
...
let n_NI_Remote_Get_Nak =
  ...
  let statement = (parallel [(assign (record [global "Sta"; arr [("UniMsg", [paramref "src"])]; global "Uni_Cmd"]) (const _UNI_Nak)); (assign (record [global "Sta"; global "NakcMsg"; global "Nakc_Cmd"]) (const _NAKC_Nakc))]) in
  rule name params formula statement

let n_NI_Remote_Get_Nak_Home =
  let name = "n_NI_Remote_Get_Nak_Home" in
  let params = [paramdef "dst" "NODE"] in
  let formula = (andList [(andList [(andList [(eqn (var (record [global "Sta"; global "HomeUniMsg"; global "Uni_Cmd"])) (const _UNI_Get)); (eqn (var (record [global "Sta"; global "HomeUniMsg"; global "Proc"])) (param (paramref "dst")))]); (eqn (var (record [global "Sta"; global "HomeUniMsg"; global "HomeProc"])) (const _False))]); (neg (eqn (var (record [global "Sta"; arr [("Proc", [paramref "dst"])]; global "CacheState"])) (const _CACHE_E)))]) in
  let statement = (parallel [(assign (record [global "Sta"; global "HomeUniMsg"; global "Uni_Cmd"]) (const _UNI_Nak)); (assign (record [global "Sta"; global "NakcMsg"; global "Nakc_Cmd"]) (const _NAKC_Nakc))]) in
  rule name params formula statement
...
let n_NI_Remote_Get_Put_Home =
  ...
  let statement = (parallel [(assign (record [global "Sta"; arr [("Proc", [paramref "dst"])]; global "CacheState"]) (const _CACHE_S)); (assign (record [global "Sta"; global "HomeUniMsg"; global "Uni_Cmd"]) (const _UNI_Put)); (assign (record [global "Sta"; global "HomeUniMsg"; global "Data"]) (var (record [global "Sta"; arr [("Proc", [paramref "dst"])]; global "CacheData"])))]) in
  rule name params formula statement

let n_NI_Local_GetX_Nak =
  let name = "n_NI_Local_GetX_Nak" in
  let params = [paramdef "src" "NODE"] in
  let formula = (andList [(andList [(eqn (var (record [global "Sta"; arr [("UniMsg", [paramref "src"])]; global "Uni_Cmd"])) (const _UNI_GetX)); (eqn (var (record [global "Sta"; arr [("UniMsg", [paramref "src"])]; global "HomeProc"])) (const _True))]); (orList [(orList [(eqn (var (record [global "Sta"; global "Dir"; global "Pending"])) (const _True)); (andList [(andList [(eqn (var (record [global "Sta"; global "Dir"; global "Dirty"])) (const _True)); (eqn (var (record [global "Sta"; global "Dir"; global "Local"])) (const _True))]); (neg (eqn (var (record [global "Sta"; global "HomeProc"; global "CacheState"])) (const _CACHE_E)))])]); (andList [(andList [(andList [(eqn (var (record [global "Sta"; global "Dir"; global "Dirty"])) (const _True)); (eqn (var (record [global "Sta"; global "Dir"; global "Local"])) (const _False))]); (eqn (var (record [global "Sta"; global "Dir"; global "HeadPtr"])) (param (paramref "src")))]); (eqn (var (record [global "Sta"; global "Dir"; global "HomeHeadPtr"])) (const _False))])])]) in
  let statement = (assign (record [global "Sta"; arr [("UniMsg", [paramref "src"])]; global "Uni_Cmd"]) (const _UNI_Nak)) in
  rule name params formula statement
...
let n_NI_Local_GetX_GetX =
  ...
  let statement = (parallel [(assign (record [global "Sta"; global "Dir"; global "Pending"]) (const (boolc true))); (assign (record [global "Sta"; arr [("UniMsg", [paramref "src"])]; global "Uni_Cmd"]) (const _UNI_GetX)); (assign (record [global "Sta"; arr [("UniMsg", [paramref "src"])]; global "Proc"]) (var (record [global "Sta"; global "Dir"; global "HeadPtr"]))); (assign (record [global "Sta"; arr [("UniMsg", [paramref "src"])]; global "HomeProc"]) (var (record [global "Sta"; global "Dir"; global "HomeHeadPtr"])))]) in
  rule name params formula statement
...
let n_NI_Remote_GetX_Nak_Home =
  ...
  let params = [paramdef "dst" "NODE"] in
  let formula = (andList [(andList [(andList [(eqn (var (record [global "Sta"; global "HomeUniMsg"; global "Uni_Cmd"])) (const _UNI_GetX)); (eqn (var (record [global "Sta"; global "HomeUniMsg"; global "Proc"])) (param (paramref "dst")))]); (eqn (var (record [global "Sta"; global "HomeUniMsg"; global "HomeProc"])) (const _False))]); (neg (eqn (var (record [global "Sta"; arr [("Proc", [paramref "dst"])]; global "CacheState"])) (const _CACHE_E)))]) in
  let statement = (parallel [(assign (record [global "Sta"; global "HomeUniMsg"; global "Uni_Cmd"]) (const _UNI_Nak)); (assign (record [global "Sta"; global "NakcMsg"; global "Nakc_Cmd"]) (const _NAKC_Nakc))]) in
  rule name params formula statement
...
let n_NI_Remote_GetX_PutX =
  ...
  let params = [paramdef "src" "NODE"; paramdef "dst" "NODE"] in
  let formula = (andList [(andList [(andList [(andList [(neg (eqn (param (paramref "src")) (param (paramref "dst")))); (eqn (var (record [global "Sta"; arr [("UniMsg", [paramref "src"])]; global "Uni_Cmd"])) (const _UNI_GetX))]); (eqn (var (record [global "Sta"; arr [("UniMsg", [paramref "src"])]; global "Proc"])) (param (paramref "dst")))]); (eqn (var (record [global "Sta"; arr [("UniMsg", [paramref "src"])]; global "HomeProc"])) (const _False))]); (eqn (var (record [global "Sta"; arr [("Proc", [paramref "dst"])]; global "CacheState"])) (const _CACHE_E))]) in
  let statement = (parallel [(assign (record [global "Sta"; arr [("Proc", [paramref "dst"])]; global "CacheState"]) (const _CACHE_I)); (assign (record [global "Sta"; arr [("UniMsg", [paramref "src"])]; global "Uni_Cmd"]) (const _UNI_PutX)); (assign (record [global "Sta"; arr [("UniMsg", [paramref "src"])]; global "Data"]) (var (record [global "Sta"; arr [("Proc", [paramref "dst"])]; global "CacheData"]))); (assign (record [global "Sta"; global "ShWbMsg"; global "Shwb_Cmd"]) (const _SHWB_FAck)); (assign (record [global "Sta"; global "ShWbMsg"; global "Proc"]) (param (paramref "src"))); (assign (record [global "Sta"; global "ShWbMsg"; global "HomeProc"]) (const (boolc false)))]) in
  rule name params formula statement
...
let n_NI_Remote_GetX_PutX_Home =
  ...
  let params = [paramdef "dst" "NODE"] in
  let formula = (andList [(andList [(andList [(eqn (var (record [global "Sta"; global "HomeUniMsg"; global "Uni_Cmd"])) (const _UNI_GetX)); (eqn (var (record [global "Sta"; global "HomeUniMsg"; global "Proc"])) (param (paramref "dst")))]); (eqn (var (record [global "Sta"; global "HomeUniMsg"; global "HomeProc"])) (const _False))]); (eqn (var (record [global "Sta"; arr [("Proc", [paramref "dst"])]; global "CacheState"])) (const _CACHE_E))]) in
  let statement = (parallel [(assign (record [global "Sta"; arr [("Proc", [paramref "dst"])]; global "CacheState"]) (const _CACHE_I)); (assign (record [global "Sta"; global "HomeUniMsg"; global "Uni_Cmd"]) (const _UNI_PutX)); (assign (record [global "Sta"; global "HomeUniMsg"; global "Data"]) (var (record [global "Sta"; arr [("Proc", [paramref "dst"])]; global "CacheData"])))]) in
  rule name params formula statement

let n_NI_Remote_Put =
  let name = "n_NI_Remote_Put" in
  let params = [paramdef "dst" "NODE"] in
  let formula = (eqn (var (record [global "Sta"; arr [("UniMsg", [paramref "dst"])]; global "Uni_Cmd"])) (const _UNI_Put)) in
  let statement = (parallel [(assign (record [global "Sta"; arr [("UniMsg", [paramref "dst"])]; global "Uni_Cmd"]) (const _UNI_None)); (assign (record [global "Sta"; arr [("Proc", [paramref "dst"])]; global "ProcCmd"]) (const _NODE_None)); (ifelseStatement (eqn (var (record [global "Sta"; arr [("Proc", [paramref "dst"])]; global "InvMarked"])) (const _True)) (parallel [(assign (record [global "Sta"; arr [("Proc", [paramref "dst"])]; global "InvMarked"]) (const (boolc false))); (assign (record [global "Sta"; arr [("Proc", [paramref "dst"])]; global "CacheState"]) (const _CACHE_I))]) (parallel [(assign (record [global "Sta"; arr [("Proc", [paramref "dst"])]; global "CacheState"]) (const _CACHE_S)); (assign (record [global "Sta"; arr [("Proc", [paramref "dst"])]; global "CacheData"]) (var (record [global "Sta"; arr [("UniMsg", [paramref "dst"])]; global "Data"])))]))]) in
  rule name params formula statement

let n_NI_Remote_PutX =
  let name = "n_NI_Remote_PutX" in
  let params = [paramdef "dst" "NODE"] in
  let formula = (andList [(eqn (var (record [global "Sta"; arr [("UniMsg", [paramref "dst"])]; global "Uni_Cmd"])) (const _UNI_PutX)); (eqn (var (record [global "Sta"; arr [("Proc", [paramref "dst"])]; global "ProcCmd"])) (const _NODE_GetX))]) in
...
let n_NI_InvAck_2 =
  ...
  let params = [paramdef "src" "NODE"] in
  let formula = (andList [(andList [(andList [(andList [(andList [(eqn (var (record [global "Sta"; arr [("InvMsg", [paramref "src"])]; global "Inv_Cmd"])) (const _INV_InvAck)); (eqn (var (record [global "Sta"; global "Dir"; global "Pending"])) (const _True))]); (eqn (var (record [global "Sta"; global "Dir"; arr [("InvSet", [paramref "src"])]])) (const _True))]); (eqn (var (record [global "Sta"; global "Dir"; global "Local"])) (const _False))]); (eqn (var (record [global "Sta"; global "Dir"; global "HomeInvSet"])) (const _False))]); (forallFormula [paramdef "p" "NODE"] (orList [(eqn (param (paramref "p")) (param (paramref "src"))); (eqn (var (record [global "Sta"; global "Dir"; arr [("InvSet", [paramref "p"])]])) (const _False))]))]) in
  let statement = (parallel [(assign (record [global "Sta"; arr [("InvMsg", [paramref "src"])]; global "Inv_Cmd"]) (const _INV_None)); (assign (record [global "Sta"; global "Dir"; arr [("InvSet", [paramref "src"])]]) (const (boolc false))); (assign (record [global "Sta"; global "Dir"; global "Pending"]) (const (boolc false)))]) in
  rule name params formula statement
...
let n_PI_Local_GetX_GetX =
  ...
  let statement = (parallel [(assign (record [global "Sta"; global "HomeProc"; global "ProcCmd"]) (const _NODE_GetX)); (assign (record [global "Sta"; global "Dir"; global "Pending"]) (const (boolc true))); (assign (record [global "Sta"; global "HomeUniMsg"; global "Uni_Cmd"]) (const _UNI_GetX)); (assign (record [global "Sta"; global "HomeUniMsg"; global "Proc"]) (var (record [global "Sta"; global "Dir"; global "HeadPtr"]))); (assign (record [global "Sta"; global "HomeUniMsg"; global "HomeProc"]) (var (record [global "Sta"; global "Dir"; global "HomeHeadPtr"])))]) in
  rule name params formula statement
...
let n_NI_Nak_Home =
  ...
  let params = [] in
  let formula = (eqn (var (record [global "Sta"; global "HomeUniMsg"; global "Uni_Cmd"])) (const _UNI_Nak)) in
  let statement = (parallel [(assign (record [global "Sta"; global "HomeUniMsg"; global "Uni_Cmd"]) (const _UNI_None)); (assign (record [global "Sta"; global "HomeProc"; global "ProcCmd"]) (const _NODE_None)); (assign (record [global "Sta"; global "HomeProc"; global "InvMarked"]) (const (boolc false)))]) in
  rule name params formula statement

let n_NI_Nak_Clear =
  let name = "n_NI_Nak_Clear" in
  let params = [] in
  let formula = (eqn (var (record [global "Sta"; global "NakcMsg"; global "Nakc_Cmd"])) (const _NAKC_Nakc)) in
  let statement = (parallel [(assign (record [global "Sta"; global "NakcMsg"; global "Nakc_Cmd"]) (const _NAKC_None)); (assign (record [global "Sta"; global "Dir"; global "Pending"]) (const (boolc false)))]) in
  rule name params formula statement

let n_NI_Local_Put =
  let name = "n_NI_Local_Put" in
  let params = [] in
  let formula = (eqn (var (record [global "Sta"; global "HomeUniMsg"; global "Uni_Cmd"])) (const _UNI_Put)) in
...
let n_NI_Local_PutXAcksDone =
  ...
  let params = [] in
  let formula = (eqn (var (record [global "Sta"; global "HomeUniMsg"; global "Uni_Cmd"])) (const _UNI_PutX)) in
  let statement = (parallel [(assign (record [global "Sta"; global "HomeUniMsg"; global "Uni_Cmd"]) (const _UNI_None)); (assign (record [global "Sta"; global "Dir"; global "Pending"]) (const (boolc false))); (assign (record [global "Sta"; global "Dir"; global "Local"]) (const (boolc true))); (assign (record [global "Sta"; global "Dir"; global "HeadVld"]) (const (boolc false))); (assign (record [global "Sta"; global "HomeProc"; global "ProcCmd"]) (const _NODE_None)); (assign (record [global "Sta"; global "HomeProc"; global "InvMarked"]) (const (boolc false))); (assign (record [global "Sta"; global "HomeProc"; global "CacheState"]) (const _CACHE_E)); (assign (record [global "Sta"; global "HomeProc"; global "CacheData"]) (var (record [global "Sta"; global "HomeUniMsg"; global "Data"])))]) in
  rule name params formula statement
...
let n_NI_Wb =
  let name = "n_NI_Wb" in
  let params = [] in
  let formula = (eqn (var (record [global "Sta"; global "WbMsg"; global "Wb_Cmd"])) (const _WB_Wb)) in
...
let n_NI_FAck =
  ...
  let params = [] in
  let formula = (eqn (var (record [global "Sta"; global "ShWbMsg"; global "Shwb_Cmd"])) (const _SHWB_FAck)) in
...
let n_NI_ShWb =
  ...
  let params = [] in
  let formula = (eqn (var (record [global "Sta"; global "ShWbMsg"; global "Shwb_Cmd"])) (const _SHWB_ShWb)) in
...
let n_NI_Replace_Home =
  ...
  let params = [] in
  let formula = (eqn (var (record [global "Sta"; global "HomeRpMsg"; global "Rp_Cmd"])) (const _RP_Replace)) in
  let statement = (parallel [(assign (record [global "Sta"; global "HomeRpMsg"; global "Rp_Cmd"]) (const _RP_None)); (ifStatement (eqn (var (record [global "Sta"; global "Dir"; global "ShrVld"])) (const _True)) (parallel [(assign (record [global "Sta"; global "Dir"; global "HomeShrSet"]) (const (boolc false))); (assign (record [global "Sta"; global "Dir"; global "HomeInvSet"]) (const (boolc false)))]))]) in
  rule name params formula statement
...
let () = run_with_cmdline (fun () ->
  ...
  let cinvs_with_varnames, relations = anotherFind protocol
    ~murphi:(In_channel.read_all "n_flash_data_cubLyj1.m")
  in
