...
let n_inv_2 =
  let name = "n_inv_2" in
  let params = [paramdef "p__Inv1" "client"] in
  let formula = (neg (andList [(eqn (var (global "x")) (const (boolc true))); (eqn (var (arr [("n", [paramref "p__Inv1"])])) (const _C))])) in
  prop name params formula

let n_inv_3 =
  let name = "n_inv_3" in
  let params = [paramdef "p__Inv0" "client"; paramdef "p__Inv1" "client"] in
  let formula = (neg (andList [(eqn (var (arr [("n", [paramref "p__Inv0"])])) (const _E)); (eqn (var (arr [("n", [paramref "p__Inv1"])])) (const _C))])) in
  prop name params formula

let n_inv_4 =
  let name = "n_inv_4" in
  let params = [paramdef "p__Inv1" "client"] in
  let formula = (neg (andList [(eqn (var (global "x")) (const (boolc true))); (eqn (var (arr [("n", [paramref "p__Inv1"])])) (const _E))])) in
  prop name params formula

let n_inv_5 =
  let name = "n_inv_5" in
  let params = [paramdef "p__Inv0" "client"; paramdef "p__Inv1" "client"] in
  let formula = (neg (andList [(eqn (var (arr [("n", [paramref "p__Inv0"])])) (const _C)); (eqn (var (arr [("n", [paramref "p__Inv1"])])) (const _C))])) in
  prop name params formula

let n_inv_6 =
  let name = "n_inv_6" in
  let params = [paramdef "p__Inv0" "client"; paramdef "p__Inv1" "client"] in
  let formula = (neg (andList [(eqn (var (arr [("n", [paramref "p__Inv0"])])) (const _E)); (eqn (var (arr [("n", [paramref "p__Inv1"])])) (const _E))])) in
  prop name params formula
